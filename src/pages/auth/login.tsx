	...
	useEffect(() => {
		...
		if (query && query?.error) {
			switch (query.error) {
				...
				case 'AccessDenied':
					setError(
						'You are not authorized to access Latitude. Please contact support if you believe this is an error.'
					)
					break
				case 'EmailCreateAccount':
					setError(
						'Failed to create new account. Please contact support for assistance.'
					)
					break
				case 'EmailSignin':
					setError(
						'Failed to send your passwordless link. Please check your email and try again.'
					)
					break
