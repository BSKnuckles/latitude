					...
					<Popover>
						<div className="mx-auto max-w-7xl px-4 sm:px-6">
							...
							>
								...
								<div className="hidden md:absolute md:inset-y-0 md:right-0 md:flex md:items-center md:justify-end md:space-x-4">
									<span className="inline-flex rounded-md shadow">
										<Link href="/auth/register">
											<a className="inline-flex items-center rounded-md border border-transparent bg-white px-4 py-2 text-base font-medium text-indigo-600 hover:text-indigo-500">
												Sign Up
											</a>
										</Link>
									</span>
									<span className="inline-flex rounded-md shadow">
										<Link href="/auth/login">
											<a className="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white hover:bg-indigo-500">
												Log in
											</a>
										</Link>
									</span>
						...
						>
							...
							>
								<div className="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
									...
									<Link href="/auth/login">
										<a className="block w-full bg-gray-50 px-5 py-3 text-center font-medium text-indigo-600 hover:bg-gray-100 hover:text-indigo-700">
											Log in
										</a>
									</Link>
								</div>
